...
function change_profile_image($id, $file_temp, $file_extn)
{
  ...
  $file_path2 = '../profile/' . substr(md5(time()), 0, 10) . '.' . $file_extn;
  mysqli_query($db, "UPDATE signup SET profile='" . $file_path2 . "'  WHERE id =$id");
}
...
function change_idcard_image($id, $file_temp, $file_extn)
{
  ...
  move_uploaded_file($file_temp, $file_path);
  $file_path2 = '../id-card/' . substr(md5(time()), 0, 10) . '.' . $file_extn;
  mysqli_query($db, "UPDATE signup SET idcard='" . $file_path2 . "'  WHERE id =$id");
}
...
<div class="collapse navbar-collapse" id="navcol-1" style="background-color:#3b99e0;width:328px;margin:0;">
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="style=" text-decoration: underline; class="nav-item" role="presentation"><a class="nav-link active"
                href="signup.php">SIGNUP MEMBERS</a></li>
    ...
    <a href="include/logout.php" class="btn btn-primary" type="submit" style="background-color:rgb(13,230,34);">LOGOUT
        <?= $_SESSION['name']; ?></a>
...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-xl-4 offset-xl-4">
            <h2 style="color:rgb(255,255,255);"><strong><span style="text-decoration: underline;">EDIT
                    ...
                    <h3>Id Card</h3>
                        ...
                        if (isset($_FILES['idcard']) === true) {
                            ...
                            if (empty($idcard) === false) {
                                echo '<img class="square-circle" src="../../', $idcard, '" alt="', $name, '" width="200px" height="200px" style="margin:12px;">';
                            } else echo '<img class="square-circle" src="../../id-card/index.jpg" alt="', $name, '" width="200px" height="200px" style="margin:12px;">';
                            ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="margin:0;background-color:#ffffff;">
                    <form style="background-color: white;" method="post" action="server.php"
              ...
              <option selected value='no'>No</option>";
                      ...
                      ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                style="color: black; height: 100px !important; width: 600px !important; font-size: 14px !important; background-color:   #E0E0E0;"
                                cols="30" rows="10" class="form-control" id="message"
